...
$table_name="food";
$conn=new mysqli($server_name,$user_name,$user_password,$database_name);
$sql1 = mysqli_query($conn,"INSERT INTO food VALUES ('$fid', '$kind', '$size', '$waittime','$price')");
$myfile = fopen("recordlog.txt", "a+");
$np='The record of FoodID = '.$fid.' has been added at '.date("h:i:sa").' on '.date("Y/m/d").'<br>';
$txt=$np;
fwrite($myfile, $txt);
fclose($myfile);
}
...
<form name="f1" action="Assign7(admin1).php" method="POST"  > 
<fieldset>
<p>FoodID:</p>
...
<p>
<input type="submit" name="sub1" value="Add a record!"/>
</p> 
</fieldset> 
 </form>
